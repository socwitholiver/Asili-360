...
export default function Index() {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative flex min-h-[92vh] items-center justify-center overflow-hidden px-4 pt-28 pb-14 md:pt-32">
        <img src={getImage('hero-savannah')} alt="Kenya savannah" className="absolute inset-0 h-full w-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-b from-foreground/45 via-foreground/18 to-background" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,194,77,0.16),transparent_42%)]" />
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          <motion.h1
            ...
            className="font-display mb-4 text-4xl font-bold text-primary-foreground sm:text-5xl md:text-7xl"
          >
          ...
          <motion.p
            ...
            className="font-body mx-auto mb-8 max-w-2xl text-base text-primary-foreground/85 sm:text-lg md:text-xl"
          >
          ...
          <motion.div
            ...
            className="mx-auto flex w-full max-w-2xl flex-col gap-2 rounded-2xl bg-card/94 p-2 shadow-elevated backdrop-blur-lg sm:flex-row sm:items-center"
          >
            ...
            <a
              ...
              className="gradient-sunset rounded-xl px-6 py-3 text-center font-semibold text-primary-foreground transition-opacity hover:opacity-90"
            >
              Explore
            </a>
          </motion.div>
          <motion.div
            ...
            className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm tracking-[0.12em] text-primary-foreground/72"
          >
      ...
      <section id="featured-experiences" className="px-4 py-20">
      ...
      <section className="bg-muted/50 px-4 py-16">
        <div className="container mx-auto">
          ...
          <p className="mb-10 text-center text-muted-foreground">Explore Kenya's most loved regions</p>
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
            {destinations.map((destination, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative h-40 cursor-pointer overflow-hidden rounded-xl"
              >
                <img
      ...
      <section className="px-4 py-20">
        <div className="container mx-auto">
          <div className="gradient-sunset relative overflow-hidden rounded-2xl p-10 text-center md:p-16">
            <div
            ...
            <Link
              to="/ai-planner"
              className="relative inline-flex items-center gap-2 rounded-xl bg-card px-8 py-3 font-semibold text-foreground transition-colors hover:bg-card/90"
            >
      ...
      <section className="bg-muted/30 px-4 py-16">
        <div className="container mx-auto">
          ...
          <p className="mb-10 text-center text-muted-foreground">Real experiences from our community</p>

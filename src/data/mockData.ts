export interface SME {
  id: string;
  name: string;
  category: 'artisan' | 'guesthouse' | 'food' | 'nganya' | 'safari' | 'cultural';
  location: string;
  county: string;
  description: string;
  price: number;
...
export const tourists: Tourist[] = [
  { id: 't1', name: 'Marie Dubois', city: 'Paris', country: 'France', avatar: '🇫🇷' },
  { id: 't2', name: 'James Ochieng', city: 'Nairobi', country: 'Kenya', avatar: '🇰🇪' },
  { id: 't3', name: 'Li Wei', city: 'Beijing', country: 'China', avatar: '🇨🇳' },
  { id: 't4', name: 'Sarah Mitchell', city: 'London', country: 'UK', avatar: '🇬🇧' },
  { id: 't5', name: 'Carlos Rivera', city: 'Mexico City', country: 'Mexico', avatar: '🇲🇽' },
];

export const smes: SME[] = [
  {
    id: 's1', name: "Mama Achieng's Beadwork", category: 'artisan', location: 'Kisumu', county: 'Kisumu',
    description: 'Handcrafted Maasai-inspired beadwork jewelry and accessories. Each piece tells a story of Kenyan heritage.',
    price: 3000, currency: 'KES', rating: 4.8, reviewCount: 24, image: 'beadwork',
    features: ['Handmade', 'Cultural Heritage', 'Workshop Available', 'Custom Orders']
  },
  {
    id: 's2', name: "David's Guesthouse", category: 'guesthouse', location: 'Amboseli', county: 'Kajiado',
    description: 'Cozy eco-lodge with stunning views of Mount Kilimanjaro. Perfect base for safari adventures.',
    price: 8500, currency: 'KES', rating: 4.6, reviewCount: 38, image: 'guesthouse',
    features: ['Mountain View', 'Eco-Friendly', 'Safari Transfers', 'Local Cuisine']
  },
  {
    id: 's3', name: 'Nairobi Street Food Tour', category: 'food', location: 'Nairobi CBD', county: 'Nairobi',
    description: 'Explore Nairobi\'s vibrant food scene — from nyama choma to mutura, samosas to sugarcane juice.',
    price: 2500, currency: 'KES', rating: 4.9, reviewCount: 56, image: 'street-food',
    features: ['Guided Tour', '8+ Food Stops', '3 Hours', 'Vegetarian Options']
  },
  {
    id: 's4', name: 'City Lights Nganya Ride', category: 'nganya', location: 'Nairobi', county: 'Nairobi',
    description: 'Experience Nairobi\'s legendary matatu culture — graffiti buses, booming sound systems, neon lights.',
    price: 1500, currency: 'KES', rating: 4.7, reviewCount: 42, image: 'nganya-ride',
    features: ['Graffiti Art Bus', 'Sound System', 'Night Tour', 'Photo Ops']
  },
  {
    id: 's5', name: 'Amboseli Safari Experience', category: 'safari', location: 'Amboseli NP', county: 'Kajiado',
    description: 'Full-day guided safari with elephant herds, big cats, and breathtaking Kilimanjaro views.',
    price: 12000, currency: 'KES', rating: 4.9, reviewCount: 67, image: 'safari',
    features: ['Game Drive', 'Professional Guide', 'Lunch Included', 'Photography']
  },
  {
    id: 's6', name: 'Lamu Heritage Walk', category: 'cultural', location: 'Lamu Old Town', county: 'Lamu',
    description: 'Wander through UNESCO-listed Lamu Old Town with a local historian. Discover Swahili architecture.',
    price: 2000, currency: 'KES', rating: 4.5, reviewCount: 19, image: 'beadwork',
    features: ['UNESCO Site', 'Local Guide', '2 Hours', 'Historical']
  },
  {
    id: 's7', name: "Wanjiku's Coastal Guesthouse", category: 'guesthouse', location: 'Diani Beach', county: 'Kwale',
    description: 'Beachfront paradise with white sands and turquoise waters. Authentic Swahili hospitality.',
    price: 6500, currency: 'KES', rating: 4.7, reviewCount: 31, image: 'beach',
    features: ['Beach Access', 'Swahili Breakfast', 'Snorkeling', 'Airport Transfer']
  },
  {
    id: 's8', name: 'Neon Express Nganya', category: 'nganya', location: 'Nairobi', county: 'Nairobi',
    description: 'The most iconic matatu in Nairobi. LED-lit interior, massive speakers, and unforgettable vibes.',
    price: 2000, currency: 'KES', rating: 4.8, reviewCount: 35, image: 'nganya-ride',
    features: ['LED Interior', 'Premium Sound', 'DJ Onboard', 'Weekend Special']
  },
  {
    id: 's9', name: 'Maasai Village Experience', category: 'cultural', location: 'Maasai Mara', county: 'Narok',
    description: 'Immerse yourself in Maasai culture — traditional dances, warrior training, and storytelling.',
    price: 4500, currency: 'KES', rating: 4.6, reviewCount: 28, image: 'beadwork',
    features: ['Cultural Immersion', 'Dance Performance', 'Crafts Market', 'Photography']
  },
  {
    id: 's10', name: "Otieno's Lake Victoria Guesthouse", category: 'guesthouse', location: 'Kisumu', county: 'Kisumu',
    description: 'Lakeside retreat with fresh tilapia dinners and sunset boat rides on Lake Victoria.',
    price: 5500, currency: 'KES', rating: 4.4, reviewCount: 15, image: 'guesthouse',
...
export const experiences: Experience[] = [
  {
    id: 'e1', title: 'Nairobi Nganya Cultural Night', description: 'Hop aboard Nairobi\'s most vibrant matatus for a cultural ride through the city lights.',
    location: 'Nairobi', duration: '3 hours', price: 2500, currency: 'KES', rating: 4.8, reviewCount: 45,
    image: 'nganya-ride', category: 'Nightlife',
    highlights: ['Graffiti matatu ride', 'Live DJ', 'Street food stop', 'Photo opportunities']
  },
  {
    id: 'e2', title: 'Amboseli Safari & Kilimanjaro Views', description: 'A full-day safari with elephants, big cats, and the majestic Mt. Kilimanjaro.',
    location: 'Amboseli', duration: 'Full day', price: 15000, currency: 'KES', rating: 4.9, reviewCount: 78,
    image: 'safari', category: 'Safari',
    highlights: ['Elephant herds', 'Big Five sighting', 'Kilimanjaro views', 'Maasai lunch']
  },
  {
    id: 'e3', title: 'Kisumu Artisan Workshop', description: 'Learn traditional beadwork from Mama Achieng and take home your own creation.',
    location: 'Kisumu', duration: '4 hours', price: 3500, currency: 'KES', rating: 4.7, reviewCount: 32,
    image: 'beadwork', category: 'Cultural',
    highlights: ['Hands-on workshop', 'Take home souvenir', 'Local tea & snacks', 'Community visit']
  },
  {
    id: 'e4', title: 'Diani Beach Paradise Retreat', description: 'White sand beaches, snorkeling in coral reefs, and Swahili coastal cuisine.',
    location: 'Diani Beach', duration: '2 days', price: 18000, currency: 'KES', rating: 4.8, reviewCount: 41,
    image: 'beach', category: 'Beach',
    highlights: ['Snorkeling', 'Beach BBQ', 'Sunset dhow cruise', 'Coral reef tour']
  },
  {
    id: 'e5', title: 'Nairobi Food Safari', description: 'Taste your way through Nairobi\'s best street food spots — from Kenyatta Market to Gikomba.',
    location: 'Nairobi', duration: '3 hours', price: 2500, currency: 'KES', rating: 4.9, reviewCount: 56,
    image: 'street-food', category: 'Food',
...
export const reviews: Review[] = [
  ...
  { id: 'r7', touristId: 't3', smeId: 's8', rating: 5, comment: "The Neon Express is not just transport — it's art on wheels! The DJ was incredible.", date: '2026-02-14' },
...
export const itineraryTemplates = [
  ...
  },
  {
    ...
    days: [
      { day: 1, title: 'Nairobi City & Nightlife', description: 'Explore the capital, visit Karen Blixen Museum, and end with a Nganya night ride.', location: 'Nairobi', cost: 5000 },
      ...
      { day: 3, title: 'Lamu Heritage & Swahili Coast', description: 'Explore UNESCO-listed Lamu Old Town and enjoy Swahili cuisine.', location: 'Lamu', cost: 8000 },
    ]
  },
];

export function getImageForKey(key: string): string {
  // Returns the import key to map in the component
  return key;
}
